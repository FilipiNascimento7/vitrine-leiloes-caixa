...
CSS = """
:root{--azul:#0B4F9E;--azul-esc:#083A75;--laranja:#F39200;--verde:#1B8A4B;--zap:#128C4A;
...
a{color:var(--azul)}
header{background:linear-gradient(135deg,var(--azul),var(--azul-esc));color:#fff;padding:16px 24px 18px}
.wrap{max-width:1180px;margin:0 auto}
.nav-topo{display:flex;align-items:center;gap:12px;flex-wrap:wrap;padding-bottom:14px;margin-bottom:14px;
 border-bottom:1px solid rgba(255,255,255,.18)}
.nav-topo .logo{height:40px;width:auto;background:#fff;border-radius:8px;padding:4px 7px;flex:none}
.assinatura{font-size:12px;line-height:1.35;opacity:.9}
.assinatura b{display:block;font-size:13.5px;font-weight:700;opacity:1}
.nav-topo .links{margin-left:auto;display:flex;gap:6px;flex-wrap:wrap}
.nav-topo .links a{color:#fff;text-decoration:none;font-size:13.5px;font-weight:600;padding:9px 13px;
 border-radius:8px;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.2);min-height:40px;
 display:flex;align-items:center}
.nav-topo .links a:hover{background:rgba(255,255,255,.24)}
...
.btn.zap{background:var(--zap);color:#fff;font-size:16px;letter-spacing:.4px;padding:15px;min-height:52px;
 box-shadow:0 4px 14px rgba(18,140,74,.28);display:flex;align-items:center;justify-content:center;gap:9px}
.btn.zap:hover{background:#0E7A40}
.btn:focus-visible,a:focus-visible{outline:3px solid rgba(11,79,158,.5);outline-offset:2px}
...
.rodape-logo{height:38px;width:auto;display:block;margin:0 auto 10px;opacity:.95}
@media(max-width:900px){main{grid-template-columns:1fr;padding:16px 14px 50px;gap:0}}
@media(max-width:760px){
 header{padding:12px 14px}
 .nav-topo{gap:9px;padding-bottom:11px;margin-bottom:11px}
 .nav-topo .logo{height:32px}
 .assinatura{font-size:10.5px}
 .assinatura b{font-size:12px}
 .nav-topo .links{margin-left:0;width:100%;gap:5px}
 .nav-topo .links a{flex:1;justify-content:center;font-size:12px;padding:9px 4px}
 header h1{font-size:19px}
 header .end{font-size:12.5px}
 .tag{font-size:10.5px;padding:3px 8px}
 .card{padding:16px 15px;margin-bottom:14px}
 .preco b{font-size:25px}
 .precos{gap:16px}
 .eco{margin-left:0;text-align:left;width:100%}
 dl{grid-template-columns:1fr;gap:2px 0;font-size:13.5px}
...
<header>
  <div class="wrap">
    <nav class="nav-topo">
      <img class="logo" src="../img/logo-auxiliadora.png" alt="Auxiliadora Predial — Agência Hugo Lange">
      <div class="assinatura"><b>Auxiliadora Predial</b>Agência Hugo Lange · Curitiba</div>
      <div class="links">
...
<footer>
  <img class="rodape-logo" src="../img/logo-auxiliadora.png" alt="Auxiliadora Predial — Agência Hugo Lange">
  <b>Auxiliadora Predial — Agência Hugo Lange</b> · Curitiba/PR<br>
  Dados do portal de Venda de Imóveis da Caixa Econômica Federal · atualizado em {_e(atualizado)}.<br>
  Não somos a Caixa: as propostas e os lances são feitos no site oficial.
  <a href="../modalidades.html">Entenda as modalidades</a> ·
